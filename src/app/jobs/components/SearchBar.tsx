...
const SearchBar: React.FC = () => {
  return (
    <form className="flex gap-4 px-6 py-2.5 mt-6 bg-neutral-900 rounded-[30px] max-md:px-5">
      <img
        loading="lazy"
      ...
      <input
        type="text"
        id="search"
        className="flex-auto self-start mt-3 w-[284px] bg-transparent text-white outline-none"
